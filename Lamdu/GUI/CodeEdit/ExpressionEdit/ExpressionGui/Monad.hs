...
module Lamdu.GUI.CodeEdit.ExpressionEdit.ExpressionGui.Monad
...
import Lamdu.GUI.CodeEdit.ExpressionEdit.ExpressionGui.Types (ExpressionGui, WidgetT, ParentPrecedence(..), Precedence)
