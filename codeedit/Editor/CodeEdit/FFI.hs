...
class FromExpr a where
  fromExpr :: Env -> Data.PureExpression Data.DefinitionIRef -> a

class ToExpr a where
  toExpr :: Env -> a -> [Data.PureExpression Data.DefinitionIRef] -> Data.PureExpression Data.DefinitionIRef
...
table :: Env -> Map Data.FFIName ([Data.PureExpression Data.DefinitionIRef] -> Data.PureExpression Data.DefinitionIRef)
table env =
  Map.fromList
