...
makeName :: Guid -> StoredNames -> NameGen Guid -> (Name, NameGen Guid)
makeName _ (StoredNames (Just storedName) _) nameGen = makeStoredName storedName nameGen
makeName guid (StoredNames Nothing (NameCount nameCounts)) nameGen =
  runState
  (Name AutoGeneratedName <$>
   NameGen.newName (`Map.notMember` nameCounts) {-TODO:-}NameGen.Independent guid)
  nameGen
...
newLocalName guid storedNames = newLocalNameHelper $ makeName guid storedNames
