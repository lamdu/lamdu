...
instance MonadTransaction m i => Order i name o (Sugar.LabeledApply v name i o) where
...
instance MonadTransaction m i => Order i name o (Sugar.Else v name i o)
instance MonadTransaction m i => Order i name o (Sugar.IfElse v name i o)
...
instance MonadTransaction m i => Order i name o (Sugar.Binder v name i o) where
