...
data P1KindedName o = P1StoredName AnnotatedName (StoredText o) | P1AnonName UUID
...
getCollision :: MMap T.Tag TagVal -> AnnotatedName -> Pass2MakeNames i o Collision
...
storedName ::
    MMap T.Tag TagVal -> AnnotatedName -> StoredText o ->
