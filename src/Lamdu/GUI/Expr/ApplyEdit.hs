...
makeArgRow ::
    ...
    Sugar.AnnotatedArg Name i o # Annotated (Sugar.Payload Name i o ExprGui.Payload) ->
...
makeSimple ::
    ...
    Annotated (Sugar.Payload Name i o ExprGui.Payload) # Sugar.App (Sugar.Term Name i o) ->
    GuiM env i o (Responsive o)
