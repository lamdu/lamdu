...
exprInfoFromPl ::
    Monad i =>
    GuiM env i o
    ((Sugar.Payload v name i0 o0, Sugar.GuiPayload) -> ExprInfo name i0 o0)
exprInfoFromPl =
    ...
    , exprInfoMinOpPrec =
        ...
        if pl ^. _2 . Sugar.plParenInfo . Sugar.piNeedParens && not isSelected
        then 0
        else pl ^. _2 . Sugar.plParenInfo . Sugar.piMinOpPrec
    , exprInfoIsSelected = isSelected
    }

add ::
    _ =>
    Options -> (Sugar.Payload v name i o, Sugar.GuiPayload) ->
