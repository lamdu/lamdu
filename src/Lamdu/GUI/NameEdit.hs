...
makeBareEdit form myId =
    case form of
    Name.Unnamed _ -> view Name.unnamedText
    Name.AutoGenerated text -> view text
    Name.Stored setName (Name.TagText text _) _ ->
        TextEdits.makeWordEdit
        ?? TextEdit.EmptyStrings "" ""
        ?? Property text setName
        ?? myId
