...
styleNameOrigin name color act =
    do
        ...
        let textEditStyle =
                style
                ^. case name ^. Name.source of
                    Name.SourceAutoGenerated -> Style.styleAutoNameOrigin
                    Name.SourceStored -> Style.styleNameOrigin
...
makeNameEdit (Name nameSrc nameCollision setName name) myId =
    ...
    where
        ...
        storedName =
            case nameSrc of
            Name.SourceAutoGenerated -> ""
            Name.SourceStored -> name
