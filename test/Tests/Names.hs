...
testWorkArea ::
    ...
    Unit (Sugar.Payload (Sugar.EvaluationScopes InternalName Identity) InternalName Identity Unit a) ->
    IO ()
...
getNames ::
    ...
    (Sugar.Payload (Sugar.EvaluationScopes name Identity) name Identity o a) ->
    [name]
getNames workArea =
