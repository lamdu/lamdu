...
infixArgs = Sugar._PNode . Sugar.val . Sugar._BodyLabeledApply . Sugar.aSpecialArgs . Sugar._Infix
...
testGetFieldOfApply =
    expr ^?!
    Sugar._PNode . Sugar.val . Sugar._BodyGetField . Sugar.gfRecord . Sugar._PNode . Sugar.ann . _2
...
testMinOpPrecInfix =
    ...
    where
        (minOpPrec, needsParens, _) = expr ^?! infixArgs . _2 . Sugar._PNode . Sugar.ann
