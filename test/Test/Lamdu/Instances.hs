...
instance (NFData a, NFData n) => NFData (Sugar.DefinitionOutdatedType n a)
...
instance NFData n => NFData (Sugar.Tag n (T i) (T o))
instance NFData n => NFData (Sugar.TagInfo n)
