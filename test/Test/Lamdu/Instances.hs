...
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.AssignPlain n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.Assignment n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.Binder n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.Body n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.Case n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.Composite n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.Else n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.ElseIfContent n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.Fragment n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.Function n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.IfElse n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.Inject n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.InjectContent n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.LabeledApply n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.Lambda n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.Let n Unit Unit) (Ann (Const a)))
deriving instance (Eq a, Eq n) => Eq (Tree (Sugar.Type n) (Ann (Const a)))
...
instance (NFData a, NFData n) => NFData (Tree (Sugar.AssignPlain n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.Assignment n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.Binder n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.Body n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.Case n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.Composite n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.Else n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.ElseIfContent n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.Fragment n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.Function n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.IfElse n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.Inject n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.InjectContent n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.LabeledApply n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.Lambda n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.Let n (T i) (T o)) (Ann (Const a)))
instance (NFData a, NFData n) => NFData (Tree (Sugar.Type n) (Ann (Const a)))
