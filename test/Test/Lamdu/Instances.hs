...
deriving instance (Eq a, Eq n) => Eq (Sugar.Body n Unit Unit # Annotated a)
...
deriving instance (Eq a, Eq n) => Eq (Sugar.Definition n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.DefinitionBody n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.DefinitionExpression n Unit Unit # Annotated a)
...
deriving instance (Eq a, Eq n) => Eq (Sugar.Pane n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.PaneBody n Unit Unit # Annotated a)
deriving instance (Eq a, Eq n) => Eq (Sugar.Payload n Unit Unit a)
deriving instance (Eq a, Eq n) => Eq (Sugar.Repl n Unit Unit # Ann (Const a))
...
deriving instance (Eq a, Eq n) => Eq (Sugar.WorkArea n Unit Unit # Annotated a)
...
instance (NFData a, NFData n) => NFData (Sugar.Body n (T i) (T o) # Annotated a)
...
instance (NFData a, NFData n) => NFData (Sugar.Definition n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.DefinitionBody n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.DefinitionExpression n (T i) (T o) # Annotated a)
...
instance (NFData a, NFData n) => NFData (Sugar.Pane n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.PaneBody n (T i) (T o) # Annotated a)
instance (NFData a, NFData n) => NFData (Sugar.Payload n (T i) (T o) a)
instance (NFData a, NFData n) => NFData (Sugar.Repl n (T i) (T o) # Ann (Const a))
...
instance (NFData a, NFData n) => NFData (Sugar.WorkArea n (T i) (T o) # Annotated a)
